...
const tiers = [
  {
    ...
    id: 'tier-hobby',
    href: '#',
    priceMonthly: 'from £89',
    description: "The perfect plan for many businesses wishing to have full virtual tour coverage.",
    features: ['25 panospheres', 'Custom Branding, Menu-driven tour', 'Stills/Aerial', 'Website integration'],
    featured: false,
  },
  {
    ...
    id: 'tier-enterprise',
    href: '#',
    priceMonthly: 'from £499',
    description: 'Suitable for multiple locations such as retail parks and units, transport hubs, stadiums, airports, distribution centres.',
    features: [
      'Multiple bespoke tours',
      'Custom Branding, Menu-driven tours',
      'Stills/Aerial',
      'Website integration',
      'Narration, video, planning',
    ],
    featured: true,
  },
];
